...
# This script runs compilation, sunchronization etc. of a Dynamics AX 2012 environment,
...
$ilCompilationTimeout = (New-TimeSpan -Hours 2).TotalSeconds
$synchronizationTimeout = (New-TimeSpan -Hours 2).TotalSeconds
